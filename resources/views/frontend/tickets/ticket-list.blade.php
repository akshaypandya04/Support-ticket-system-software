...
@section('title','Ticket - User Panel')
...
<!--start page wrapper -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ps-3">
                       ...
                       <div class="ms-auto">
                        <div class="btn-group">
                        <a href="{{route('user.add.ticket')}}"> <button type="button" class="btn btn-primary float-right" >Create Ticket</button> </a>
                        </div>
                    </div>
                </div>
    ...
    <td>
       <a class="btn btn-primary" href="{{route('user.ticket.show',$value->id)}}">View</a>
