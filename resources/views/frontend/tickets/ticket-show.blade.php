        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">My Ticket Status</div>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">My Ticket Status</li>
                            </ol>
                        </nav>
                    </div>
     ...
     <b> Message </b>  : <br><br> {!!$tickets->message!!}
                            ...
                            <div class="col-lg-8">
                             ...
                             <form enctype="multipart/form-data" class="border px-4 pt-2 pb-3" method="POST"
                                      action="{{route('user.ticket.reply')}}">
                                    @csrf        
